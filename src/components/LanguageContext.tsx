...
const translations = {
  uk: {
    ...
    formTitleAdd: "Новий запис",
    formTitleEdit: "Редагування",
    ...
    settingsHint:
      "Дані зберігаються у хмарі (Firebase). Тепер ви можете увійти з будь-якого пристрою.",
    ...
    loginTitle: "Вхід",
    loginLabel: "Нікнейм",
    loginPlaceholder: "Введіть ваше ім'я",
    loginPin: "ПІН-код (пароль)",
    pinPlaceholder: "Мінімум 6 символів",
    loginBtn: "Увійти",
    modeRegister: "Зареєструватися",
    toggleToRegister: "Немає акаунта? Створити",
    toggleToLogin: "Вже є акаунт? Увійти",
    loginLoading: "Завантаження...",
    loginError: "Будь ласка, введіть нікнейм",
    errShortPassword: "Пароль має містити мінімум 6 символів",
    errNickTaken: "Цей нікнейм вже зайнятий",
    errWrongCredentials: "Невірний нікнейм або пароль",
    authError: "Сталася помилка. Спробуйте пізніше.",
    logoutConfirm: "Ви дійсно хочете вийти?",
    logoutBtnTitle: "Вихід",
  ...
  ru: {
    ...
    settingsHint:
      "Данные хранятся в облаке (Firebase). Теперь вы можете войти с любого устройства.",
    ...
    loginTitle: "Вход",
    loginLabel: "Никнейм",
    loginPlaceholder: "Введите ваше имя",
    loginPin: "ПИН-код (пароль)",
    pinPlaceholder: "Минимум 6 символов",
    loginBtn: "Войти",
    ...
    loginError: "Пожалуйста, введите никнейм",
    errShortPassword: "Пароль должен содержать минимум 6 символов",
    errNickTaken: "Этот никнейм уже занят",
    errWrongCredentials: "Неверный никнейм или пароль",
    authError: "Произошла ошибка. Попробуйте позже.",
    logoutConfirm: "Вы действительно хотите выйти?",
    logoutBtnTitle: "Выход",
